        ...
        <div class="p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800">
            <dl class="grid max-w-screen-xl grid-cols-2 gap-8 p-4 mx-auto text-gray-900 sm:grid-cols-3 xl:grid-cols-5 dark:text-white sm:p-8">
                <div class="flex flex-col items-center justify-center">
                    ...
                    <dd class="text-gray-500 dark:text-gray-400">Number of tickets created</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
                    <dt class="mb-2 text-3xl font-extrabold"><?= $totalTicketStat["in_progress_count"] ?></dt>
                    <dd class="text-gray-500 dark:text-gray-400">Number of current tickets</dd>
                </div>
                <div class="flex flex-col items-center justify-center">
            ...
            <div class="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                <div class="grid grid-cols-3 gap-3 mb-2">
                    ...
                    <dl class="bg-teal-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                        ...
                        <dd class="text-teal-600 dark:text-teal-300 text-sm font-medium">Current tickets</dd>
                    </dl>
        ...
        <script>
            ...
            const updateRadialChart = (period) => {
                ...
                const chartOptions = {
                    ...
                    labels: ["Resolved", "Current tickets", "To do"],
                    legend: {
                        show: true,
                        position: "bottom",
                        fontFamily: "Inter, sans-serif",
