                    ...
                    ?>
                        <tr
                            ...
                            <td class="px-6 py-4">
                                ...
                                <!--
                                <div>
                                    <a href="?module=client&action=editEmailClientForm&id=<?= htmlspecialchars($client['c_id']); ?>"
                                        type="button"
                                        data-modal-target="editClientModal"
                                        data-modal-show="editClientModal"
                                        class="font-medium text-teal-600 dark:text-teal-500 hover:underline block">Edit email</a>
                                </div>
                                -->
                            </td>
                            <td class="px-6 py-4">
