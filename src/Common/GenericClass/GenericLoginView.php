...
/**
 * Classe qui est appeller par ViewConnexion dans la partie administrateur et useur pour enlever les redondances
 */
class GenericLoginView extends GenericView
{
