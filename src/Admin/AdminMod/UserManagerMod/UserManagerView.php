...
class UserManagerView extends GenericLoginView
{


    //affichage de la liste des utilisateurs
    public function showUserList($resultat, $nbr_de_pages)
    {
...
?>
                                                ...
                                                <td>
                                                    <div class="action">
                                                        ...
                                                        <a id='<?php echo $value['idUser']  ?>'
                                                            href='index.php?module=gestionUseur&action=showUserInfo&idUseur=<?php echo $value['idUser'] ?>'
                                                            class="text-success mr-4" data-toggle="tooltip" data-placement="top"
                                                            title="" data-original-title="Edit"> <i
                                                                class="fa fa-pencil h5 m-0"></i></a>
                                                        <!--Bouton Suppresion -->
                                                        <a id='<?php echo $value['idUser']  ?>'
                                                            href='index.php?module=gestionUseur&action=deleteUser&idUseur=<?php echo $value['idUser'] ?>'
    ...
    public function confirmdeleteMyAccount()
    {
    ?>
        ...
        <div class="container">
            <form
                action='index.php?module=gestionUseur&action=deleteUserConfirmer&idUseur=<?php echo (htmlspecialchars($_GET['idUseur'])); ?> '
                method="post">
    ...
    public function showUserInfo($infoUseur)
    {
    ...
    public function changeUserForm($infoUseur)
    {
    ...
    ?>
        ...
        <div class="container">
            <form action='index.php?module=gestionUseur&action=confirmCreateAdmin' method="post">
                <input type="hidden" name="token" value='<?php echo $_SESSION['token'] ?>'>
                <!--Token- -->
