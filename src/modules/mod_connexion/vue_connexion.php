...
<div class="pageCompte">
    <div>
        ...
        <form class="formulairegenerale" action="index.php?module=connexion&action=connexionidentifiant" method="post">
            ...
            <div class="boutonMdp">
                <input class="saisieText" type="password" id="monEntree" placeholder="Mot de passe" name="motDePasse"
                    required maxlength="100">
                <button type="button" class="checkboxMdp"> <img alt="oeil affichage mot de passe" id="oeil"
                        src="ressource/images/oeilCacherMdp.png" onclick="basculerAffichageMotDePasse(monEntree,oeil)">
                </button>
            </div>
