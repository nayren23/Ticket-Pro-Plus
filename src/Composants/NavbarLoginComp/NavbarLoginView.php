            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex space-x-2 mt-4 md:mt-0">
                    ...
                    if (!$estConnecte && $action !== "inscription") {
                        echo '<button onclick="window.location.href = \'index.php?module=login&action=signup\'" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Sign In</button>';
                    }

                    if (!$estConnecte && $action !== "connexion") {
                        echo '<button onclick="window.location.href = \'index.php?module=login&action=login\'" class="text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 font-medium rounded-lg text-sm px-4 py-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Log in</button>';
                    }
